...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    public Loader<String[]> onCreateLoader(int id,Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public void deliverResult(String[] wheatherData) {
                mWheatherData = wheatherData;
                super.deliverResult(wheatherData);
            }

            @Override
            public String[] loadInBackground() {
                String query = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
                URL weatherRequess = NetworkUtils.buildUrl(query);
                try {
                    String jsonWeatherResponse = NetworkUtils
                            .getResponseFromHttpUrl(weatherRequess);
