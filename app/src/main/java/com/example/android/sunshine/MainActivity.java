...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED (5) Add a forecast_list_item for an item in the list called forecast_list_item.xml
    // COMPLETED (6) Make the root of the forecast_list_item a vertical LinearLayout
    ...
    // COMPLETED (12) Add a View to the forecast_list_item with a width of match_parent and a height of 1dp
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /* Use the inflater's inflate method to inflate our menu forecast_list_item to this menu */
